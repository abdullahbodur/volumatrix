...
def export(obj: VolumatrixObject, filepath: str, format: Optional[str] = None, **kwargs) -> None:
    """
...
def _load_obj(filepath: Path, **kwargs) -> VolumatrixObject:
    ...
    try:
        ...
        return VolumatrixObject(
            name=filepath.stem,
            representations={"mesh": volumatrix_mesh}
        )
    except ImportError:
        raise ImportError("trimesh is required for OBJ file support. Install with: pip install trimesh")
...
def _load_gltf(filepath: Path, **kwargs) -> VolumatrixObject:
    ...
    try:
        ...
        raise ImportError("trimesh is required for GLTF file support. Install with: pip install trimesh")
...
def _load_ply(filepath: Path, **kwargs) -> VolumatrixObject:
    ...
    try:
        ...
        raise ImportError("trimesh is required for PLY file support. Install with: pip install trimesh")
...
def _load_stl(filepath: Path, **kwargs) -> VolumatrixObject:
    ...
    try:
        ...
        raise ImportError("trimesh is required for STL file support. Install with: pip install trimesh")
...
def _export_ply(obj: VolumatrixObject, filepath: Path, **kwargs) -> None:
    ...
    try:
        ...
        raise ImportError("trimesh is required for PLY export. Install with: pip install trimesh")
