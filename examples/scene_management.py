...
def complex_scene_layout():
    ...
    furniture_layout = [
        # Living area
        {"object": "sofa", "name": "Sofa", "position": [0, 0, 0], "rotation": [0, 0, 0]},
        {"object": "coffee table", "name": "CoffeeTable", "position": [0, 2, 0], "rotation": [0, 0, 0]},
        {"object": "lamp", "name": "FloorLamp", "position": [-2, 0, 0], "rotation": [0, 0, 0]},
        
        # Dining area
        {"object": "dining table", "name": "DiningTable", "position": [5, 0, 0], "rotation": [0, 0, 0]},
        {"object": "chair", "name": "Chair1", "position": [4, -1, 0], "rotation": [0, 0, 0]},
        {"object": "chair", "name": "Chair2", "position": [6, -1, 0], "rotation": [0, 0, 0]},
        {"object": "chair", "name": "Chair3", "position": [4, 1, 0], "rotation": [0, 0, np.pi]},
        {"object": "chair", "name": "Chair4", "position": [6, 1, 0], "rotation": [0, 0, np.pi]},
        
        # Decorative items
        {"object": "vase", "name": "Vase", "position": [0, 2, 0.5], "scale": [0.5, 0.5, 0.5]},
        {"object": "lamp", "name": "TableLamp", "position": [5, 0, 0.8], "scale": [0.7, 0.7, 0.7]},
    ]
