...
LOG_LEVELS = {
    0: (logging.CRITICAL, "%(asctime)s - %(name)s - %(levelname)s - %(message)s"),
    1: (logging.ERROR, "%(asctime)s - %(name)s - %(levelname)s - %(message)s"),
    2: (logging.WARNING, "%(asctime)s - %(name)s - %(levelname)s - %(message)s"),
    3: (logging.INFO, "%(asctime)s - %(name)s - %(levelname)s - %(message)s"),
    4: (logging.DEBUG, "%(asctime)s - %(name)s - %(levelname)s - %(message)s"),
